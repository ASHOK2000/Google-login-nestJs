...
const todo_service_1 = require("../provider/todo.service");
let TodosController = class TodosController {
    ...
    async findAll(request) {
        const students = await this.todosService.findAll();
        return students;
    }
    async update(id, body) {
        const newstudent = await this.todosService.update(id, body);
